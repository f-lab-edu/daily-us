...
class GroupMapperTest {
  ...
  void findGroupListAppliesCompositeCursor() {
    ...
    List<GroupListRow> rows = groupMapper.findGroupList(10L, sameCreatedAt,
        thirdGroup.getGroupId());
  ...
  void findMembersByMemberIdExcludesDeletedMembersAndDeletedGroups() {
    ...
    Long deletedGroupOwnerId = insertUser(uniqueEmail("deleted-owner"),
        uniqueNickname("deleted-owner"));
    Long deletedGroupMemberId = insertUser(uniqueEmail("deleted-group-member"),
        uniqueNickname("deleted-group-member"));
